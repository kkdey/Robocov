#' @title  Robust correlation estimation using box constraints on Fisher Z-scores  with slack variables
#' @description A robust estimation of correlation matrix for data with missing entries using box
#' constraint, alongside slack variables, on the Fisher z-score values with added L-1 penalty on the
#' slack variables.
#'
